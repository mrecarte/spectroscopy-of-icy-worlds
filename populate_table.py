#The purpose of this code is to populate the table with the information we have. So far, we have the USGS speclib, RRUFF, and minerals from individual 
#publications, and this program compiles their wavelength, reflectance data, along with other miscellaneous information about the mineral (i.e. chemical formula)
...
#This code should only be run once as running again will cause duplicates in the table. Should you need to run this code again, please delete minspec.db first, run 
#create_table.py, and then run this file.
